...
class IFile {
    ...
    public static class Writer<K extends Object, V extends Object> {
        ...
        public Writer(Configuration conf, FSDataOutputStream out,
                      Class<K> keyClass, Class<V> valueClass,
                      CompressionCodec codec, Counters.Counter writesCounter) throws IOException {
            ...
            this.keySerializer.open(buffer);/*调用序列化器，序列化后的数据存储在buffer中*/
            this.valueSerializer = serializationFactory.getSerializer(valueClass);
            this.valueSerializer.open(buffer);/*调用序列化器，序列化后的数据存储在buffer中*/
        }
        ...
        public void append(K key, V value) throws IOException {
            ...
            /*将key值写入到 buffer 中（之前通过open关联了buffer）*/
            ...
            /*out中的数据为 (keyLength,valueLength,key,value)*/
            ...
            decompressedBytesWritten += keyLength + valueLength +
                    WritableUtils.getVIntSize(keyLength)/*获取编码后的长度*/ +
    ...
    public static class Reader<K extends Object, V extends Object> {
         ...
         * @throws IOException
         */
        public Reader(Configuration conf, FSDataInputStream in, long length, CompressionCodec codec,
