...
public class FileOutputCommitter extends OutputCommitter {
    ...
    static final String SUCCEEDED_FILE_NAME = "_SUCCESS";
    private static final String SUCCESSFUL_JOB_OUTPUT_DIR_MARKER = "mapreduce.fileoutputcommitter.marksuccessfuljobs";
    ...
    /**
     * 删除临时目录，并在${mapred.out.dir}目录下创建空文件 _SUCCESS
     *
     * @param context
     * @throws IOException
     */
    ...
    Path getTempTaskOutputPath(TaskAttemptContext taskContext) {
        ...
        Path outputPath = FileOutputFormat.getOutputPath(conf);
        if (outputPath != null) {
            Path p = new Path(outputPath, (FileOutputCommitter.TEMP_DIR_NAME + Path.SEPARATOR +
