...
public class JspHelper {
    ...
    public void addTableRow(JspWriter out, String[] columns, int row) throws IOException {
        ...
        for (String column : columns) {
            if (row / 2 * 2 == row) {//even
                out.print("<td style=\"vertical-align: top;background-color:LightGrey;\"><B>" + column + "</B><br></td>");
            } else {
                out.print("<td style=\"vertical-align: top;background-color:LightBlue;\"><B>" + column + "</B><br></td>");
