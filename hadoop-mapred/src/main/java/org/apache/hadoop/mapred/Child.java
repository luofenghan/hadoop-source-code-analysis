...
class Child {
    ...
    /**
     * @param args args[0]：TaskTracker的IP
     *             args[1]：端口号
     *             args[2]：TaskAttempt ID
     *             args[3]：日志位置
     *             args[4]：JVM ID
     * @throws Throwable
     */
    public static void main(String[] args) throws Throwable {
        ...
        /*创建到TaskTracker的RPC连接*/
        final TaskUmbilicalProtocol umbilical =
                taskOwner.doAs((PrivilegedExceptionAction<TaskUmbilicalProtocol>) () -> (TaskUmbilicalProtocol) RPC.getProxy(TaskUmbilicalProtocol.class,
    ...
    static void localizeTask(Task task, JobConf jobConf, String logLocation) throws IOException {
        ...
        Path localTaskFile = lDirAlloc.getLocalPathForWrite(TaskTracker.JOBFILE, jobConf);
