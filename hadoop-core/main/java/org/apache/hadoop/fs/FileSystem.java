...
public abstract class FileSystem extends Configured implements Closeable {
     ...
     */
    private static final Map<Class<? extends FileSystem>, Statistics> STATISTICS_TABLE = new IdentityHashMap<Class<? extends FileSystem>, Statistics>();
     ...
     * @throws IOException if encounter any problem while fetching the status
     */
     ...
     *
     * @param paths the list of paths we want information from
    ...
    private FileStatus[] getFileStatus(Path[] paths) throws IOException {
        ...
        for (Path path : paths) {
            try {
                results.add(getFileStatus(path));
    ...
    public static synchronized List<Statistics> getAllStatistics() {
        return new ArrayList<Statistics>(STATISTICS_TABLE.values());
    }
