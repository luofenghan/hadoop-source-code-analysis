...
public class DatanodeInfo extends DatanodeID implements Node {
    ...
    protected long dfsUsed; // 已使用的容量
    protected long remaining; // 剩余容量
    protected long lastUpdate; // 状态更新时间
    protected int xceiverCount; // 流接口服务线程数
    protected String location = NetworkTopology.DEFAULT_RACK; //数据节点在集群中的位置
    ...
    public String getDatanodeReport() {
        ...
        buffer.append("DFS Used%: ").append(StringUtils.limitDecimalTo2(usedPercent)).append("%\n");
        buffer.append("DFS Remaining%: ").append(StringUtils.limitDecimalTo2(remainingPercent)).append("%\n");
    ...
    static {                                      // register a ctor
        WritableFactories.setFactory(DatanodeInfo.class, DatanodeInfo::new);
    }
